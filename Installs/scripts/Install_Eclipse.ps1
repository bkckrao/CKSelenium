...
if(Get-Command $Package -ErrorAction SilentlyContinue)
    ...
    # Eclipse unzipping and creating short cut on the desktop
     #   Install_Eclipse_extenstion.ps1
     
     Write-Output "Running Eclipse extension ... "
     &"$PSScriptRoot\Install_Eclipse_extenstion.ps1"
     

     Write-Output "Running TestNG plugin Install ..."
     &"$PSScriptRoot\TestNG_PluginInstall.ps1"
